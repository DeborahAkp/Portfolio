...
- Canada in the Canada market has the lowest total sales ($66,928.17). - I'm not sure if this is useful since Canada is technically both highest and lowest
...
- Would this be better: There has been a positive trend in sales growth over the four-year period, with total sales increasing 90.3% from $2,259,451.64 in 2011 to $4,299,867.67 in 2014.
...
- Same as above
- Maybe Could also point out that profit increase is proportional with only slight increase in profit margin: profit margin in 2011 was 11.01%; 2014 was 11.72%
- I don't know if the profit margin increase os relevant but YoY% might be useful
  
| order_year | Profit Margin | YOY%   |
|------------|---------------|--------|
| 2011       | 11.02%        |        |
| 2012       | 11.48%        | 23.49% |
| 2013       | 11.95%        | 32.37% |
...
- I think it would be ok with just: The fourth quarter consistently has the highest total sales and total profit rankings across all years
- Maybe also: The fourth quarter consistently has the highest total sales and total profit rankings across all years. Over 30% of yearly sales revenue and profit was generated in Q4 every year.
...
- Instead of both lines above, could have: The subcategory "Chairs" has the highest total sales within the Furniture category and 2nd-highest profit. The subcategory "Bookcases" has the highest total profit and the 2nd-highest total sales.
...
- Maybe: The subcategory "Tables" has the lowest total profit
...
- Same comment as in the Furniture category
...
- Labels and Fasteners have lowest & 2nd Lowest sales and profit respectively
...
- Same comment as in Furniture category
...
- Lowest sales is "Accessories", lowest profit is "Machines"
...
- The Corporate segment has the second-highest total sales and total profit. It contributes 30.25% of total sales and 30.07% of total profit.

__Home Office Segment__
- The Home Office segment has the lowest total sales and total profit among the three segments. Although it ranks third in both sales and profit, it still makes a notable contribution to the company's overall revenue and profitability. The Home Office segment represents 18.27% of total sales and 18.88% of total profit.


- neither here nor there but the profit margin of each sector is pretty consistent with that of the company, hovering around 11% at 11.51%, 11.54%, 11.99%
...
- I think it could be just: The __"Standard Class"__ shipping mode has the highest total sales and total profit. It has the most number of orders among all the shipping modes
...
- I think 2012 should be 4.89%: [(1373/1309)-1]
...
- If 2011 is year 1, should all the customers be new customers? idk
...
- I think this is ok: The __average order value__ is $246.49
...
FROM segment_growth;
```
__CONCAT(ROUND((((total_sales) - (total_sales_prev_year))/ (total_sales)) *100, 2), '%') AS sales_growth should be:__
__CONCAT(ROUND((((total_sales) - (total_sales_prev_year))/ (total_sales_prev_year)) *100, 2), '%') AS sales_growth__
...
- I think maybe this part isn't necessary:  There were no orders in this ship mode that were shipped on the same day (0 days).
